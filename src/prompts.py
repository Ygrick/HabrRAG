...
PARAPHRASE_PROMPT = """
Ты LLM-инженер и должен перефразировать вопросы пользователя, исправив грамматику, но не меняя смысл. 
В ответе предоставь только переформулированный вопрос без лишнего текста.
"""
